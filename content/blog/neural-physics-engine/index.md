...
![IRIS algorithm](IRIS_algorithm.png)
...
<video class="media" controls autoplay muted loop playsinline>
  <source src="parallel_pong.mp4" type="video/mp4">
</video>
<p class="caption">12 games played by our random agent. It is recommended to watch it on fullscreen.</p>
...
![Autoencoder diagram](autoencoder.png)
...
<video class="media" controls preload="metadata" playsinline>
  <source src="learning_vae.mp4" type="video/mp4">
</video>
...
![Losses of GPT and VQ-VAE during training](losses_pong.png)
