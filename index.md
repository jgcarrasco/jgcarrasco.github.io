...
For a list of all publications, check [Google Scholar](https://scholar.google.com/citations?user=48GgM40AAAAJ&amp;hl=en)

- <u>Jorge García-Carrasco</u>, Alejandro Maté, and Juan Carlos Trujillo. *"Extracting Interpretable Task-Specific Circuits from Large Language Models for Faster Inference"* **(AAAI 25)** [Paper]() [Code](https://github.com/jgcarrasco/circuit-extraction)

- <u>Jorge García-Carrasco</u>, Alejandro Maté, and Juan Carlos Trujillo. *"Detecting and Understanding Vulnerabilities in Language Models via Mechanistic Interpretability."* **(IJCAI 24)** [Paper](https://arxiv.org/abs/2407.19842) [Code](https://github.com/jgcarrasco/detecting-vulnerabilities-mech-interp)

- <u>Jorge García-Carrasco</u>, Alejandro Maté, and Juan Carlos Trujillo. *"How does GPT-2 Predict Acronyms? Extracting and Understanding a Circuit via Mechanistic Interpretability."* **(AISTATS 24)** [Paper](https://arxiv.org/abs/2405.04156) [Code](https://github.com/jgcarrasco/acronyms_paper)</a> 
